...
The first step that must be done is to filter the image we get from the frontal camera of the drone. As the mouse is red, a red filter has been implemented. 

![image](../assets/images/mouse_drone_filtered.png.png)
